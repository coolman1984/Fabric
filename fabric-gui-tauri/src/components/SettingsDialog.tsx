            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-background border border-border shadow-2xl rounded-2xl flex flex-col overflow-hidden"
                    >
                        {/* Header */}
                        ...
                        {/* Content */}
                        <div className="flex-1 overflow-y-auto p-6 space-y-8 style-scrollbar max-h-[70vh]">
                            {/* API Keys */}
                            ...
                            <div className="p-4 bg-muted/50 rounded-xl flex gap-3 border border-border">
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    API keys are stored locally on your machine. They are never sent to any server except the respective AI provider.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-6 border-t border-border flex justify-end">
                            <button
                                onClick={onClose}
                                className="px-6 py-2 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98]"
                            >
                                Save & Finish
                            </button>
                        </div>
